    ...
    public function Panel()
    {
        ...
        if($roles[0] == 'Usuario'){
            ...
            ->where('responsable_id', $use->id)->get();
             ...
             })->select('tickets.*','users.email')->where('status_id',1)->where('areas.id_supervisor_area',$use->id)->orWhere('users.supervisor_rectoria',$idUse)->get();
        ...
        if($roles[0] == 'Usuario'){
            ...
            $completados = DB::table('tickets')
             ->join('areas', function ($join){
                 ...
                 $join->on('tickets.responsable_id', '=', 'users.id');
             })->select('tickets.*','users.email')->where('status_id',2)->where('areas.id_supervisor_area',$use->id)->orWhere('users.supervisor_rectoria',$idUse)->get();
        }else if($roles[0] == 'Superusuario'){
        ...
        if($roles[0] == 'Usuario'){
            ...
            $cancelado = DB::table('tickets')
             ->join('areas', function ($join){
                 ...
                 $join->on('tickets.responsable_id', '=', 'users.id');
             })->select('tickets.*','users.email')->where('status_id',3)->where('areas.id_supervisor_area',$use->id)->orWhere('users.supervisor_rectoria',$idUse)->get();
        }else if($roles[0] == 'Superusuario'){
        ...
        if($roles[0] == 'Usuario'){
            ...
            $validacion = DB::table('tickets')
             ->join('areas', function ($join){
                 ...
                 $join->on('tickets.responsable_id', '=', 'users.id');
             })->select('tickets.*','users.email')->where('status_id',4)->where('areas.id_supervisor_area',$use->id)->orWhere('users.supervisor_rectoria',$idUse)->get();
        }else if($roles[0] == 'Superusuario'){
        ...
        if($roles[0] == 'Usuario'){
            ...
            $perdido = DB::table('tickets')
             ->join('areas', function ($join){
                 ...
                 $join->on('tickets.responsable_id', '=', 'users.id');
             })->select('tickets.*','users.email')->where('status_id',5)->where('areas.id_supervisor_area',$use->id)->orWhere('users.supervisor_rectoria',$idUse)->get();
        }else if($roles[0] == 'Superusuario'){
